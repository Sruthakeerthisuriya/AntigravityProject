...
describe('Math Operations Comprehensive Unit Tests', () => {
    ...
    describe('exponentiate', () => {
        ...
        test('raises zero to the power of zero', () => {
            // In JavaScript, Math.pow(0,0) is 1
        ...
        test('raises 1 to any power', () => {
            ...
            expect(exponentiate(1, Infinity)).toBeNaN(); // Math.pow(1, Infinity) is NaN in some specs, but JS returns 1 if exponent is Infinity? No, Math.pow(1, Infinity) is 1.
