...
describe('Math Operations Comprehensive Unit Tests', () => {
    describe('add', () => {
        ...
        test('returns NaN when inputs are invalid types', () => {
            ...
            expect(add(Symbol('test'), 5)).toBeNaN();
        });
    ...
    describe('multiply', () => {
        ...
        test('handles signed zeros', () => {
            const resultPos = multiply(5, 0);
            expect(Object.is(resultPos, 0)).toBe(true);
            
            const resultNeg = multiply(-5, 0);
            expect(Object.is(resultNeg, -0)).toBe(true);
            
            const resultBothNeg = multiply(-5, -0);
            expect(Object.is(resultBothNeg, 0)).toBe(true);
        });
    });
    ...
    describe('exponentiate', () => {
        ...
        test('handles NaN', () => {
            ...
            expect(exponentiate(NaN, NaN)).toBeNaN();
        });
    });
});